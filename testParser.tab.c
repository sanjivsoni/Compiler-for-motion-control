...
static const char *const yytname[] =
{
  ...
  "END", "OBSTACLE", "NUMBER", "COORDINATE", "LBRACKET", "RBRACKET",
  "COMMA", "$accept", "PARSETREE", "LINES", "LINE", "ASSIGN_INT",
  "ASSIGN_COORDINATE", "ASSIGN_OBSTACLE", "HINDERENCES", "HINDERENCE", 0
};
#endif
